    ...
    if (isset($_SESSION['user'])) {
        ...
        if ($validation_flag == 0) {
            ...
            if ($validation_flag == 0) {
                ...
                $query = "INSERT INTO `event_slots` (`event_id`,`start_date`,`end_date`,`start_time`,`end_time`,`timezone`,`slot_type`,`slot_interval`,`total_slots`,`attendee_type`,`attendee_limit`,`recurring_type`,`recurring_weeks`,`recurring_months_base`,`recurring_month_date`,`recurring_month_every`,`recurring_month_day`,`registration_cut_off`,`status`,`created`,`created_by`) VALUES ( '" . $event_id . "', '" . $start_date . "','" . $end_date . "','" . $start_time . "','" . $end_time . "','" . $timezone . "','" . $slot_type . "','" . $slot_interval . "','" . $total_slots . "','" . $attendee_type . "','" . $attendee_limit . "','" . $recurring_type . "','" . $recurring_weeks_in . "','" . $recurring_months_base . "','" . $recurring_month_date_in . "','" . $recurring_month_every_in . "','" . $recurring_month_day_in . "','" . $registration_cut_off . "','" . $status . "','" . $created . "','" . $created_by . "');";
